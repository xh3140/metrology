...
import kotlinx.android.synthetic.main.fragment_jjg_1163_2019_part1.*
import kotlinx.android.synthetic.main.include_raw_data_button_group.*


/**
 * @Author : xh3140
 * @Time : 2020/7/17 18:42
 * @File : JJGN1163Y2019P1Fragment.kt
 */

class JJGN1163Y2019P1Fragment : BaseFragment() {
    override fun getLayoutResID(): Int = R.layout.fragment_jjg_1163_2019_part1
